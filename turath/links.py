...
MIN_WORDS = 5          # أقل عدد كلمات متتالية يُعتدّ به اقتباسًا
# عُيِّرت على آيتين: آية الكرسي (لفظ مميّز طويل) وآية الوضوء (تُقتبس في
# جُمَل قصيرة: الغَسل، المسح، التيمم). العتبة ٦ كانت تُسقِط اقتباسات
# صحيحة من خمس كلمات. الاشتراك بين الآيات يُكشف بفحص المصحف كاملًا لا
# بإطالة العتبة — «فلم تجدوا ماء فتيمموا صعيد» يرد في ٥:٦ و٤:٤٣ معًا
# فيُوسَم ملتبسًا، بينما «فاغسلوا وجوهكم…» ينفرد بـ٥:٦ فلا يُوسَم.
