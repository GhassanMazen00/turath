...
const siraAge=(y)=>53+y;
/* لا يُقال في المولد «ابن نحو صفر» */
const siraAgeAr=(y)=>{const a=siraAge(y);
  return a<=0?"":'ﷺ ابن نحو <bdi>'+AR(a)+'</bdi> سنة';};
function siraYear(y){
  if(y===0) return "";
...
const TIERS=[["q","القرآن","ما نزل فيه من المصحف"],
             ["h","كتب الحديث","ما رُوي فيه بأسانيده ودرجاته"],
             ["s","كتب السيرة","ما ساقه ابن هشام والواقدي"]];
