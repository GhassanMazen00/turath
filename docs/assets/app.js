...
const SRCBOOKS=[
 ...
 ["ما نقصنا فنقوله",[
  ...
  ["أحكام المحدّثين لا تشمل كل الكتب","الأحكام المشحونة على أحاديث الكتب العشرة الأولى. وأمّا سنن الدارمي ورياض الصالحين ومشكاة المصابيح وبلوغ المرام والأدب المفرد والشمائل فليس لمتونها في مصدرنا أحكامٌ مفهرسة، فيُقال في صفحاتها «لم يرد حكم في المصدر» ولا يُنسب إلى عالمٍ ما لم يقله."],
